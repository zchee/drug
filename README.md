...
drug command records the ingestion time of the medicine.

| **CI (linux)**                              | **godoc.org**                      | **codecov.io**                          | **Release**                          |
|:-------------------------------------------:|:----------------------------------:|:---------------------------------------:|:------------------------------------:|
| [![circleci.com][circleci-badge]][circleci] | [![godoc.org][godoc-badge]][godoc] | [![codecov.io][codecov-badge]][codecov] | [![Release][release-badge]][release] |
